...
var fluidPlayerClass = {
    ...
    version: '2.4.2',
    homepage: 'http://www.softintechnology.com/',
    ...
    setCustomContextMenu: function () {
        ...
        divContextMenu.innerHTML = '<ul>' +
            ...
            '    <li id="' + player.videoPlayerId + 'context_option_homepage">Softin Technology</li>' +
            '</ul>';
    ...
    setupPlayerWrapper: function () {
        ...
        divVideoWrapper.style.width = '100%';
        divVideoWrapper.style.height = 'auto';
        divVideoWrapper.style.display = "block";
        divVideoWrapper.style.marginLeft = "auto";
        divVideoWrapper.style.marginRight = "auto";
                ...
                sourceChangeDiv.addEventListener('click', function (event) {
                    ...
                    player.videoSources.forEach(function (source) {
                        if (source.title == videoChangedTo.innerText.replace(/(\r\n\t|\n|\r\t)/gm, "")) {
                            ...
                            player.setCurrentTimeAndPlay(0, false);
